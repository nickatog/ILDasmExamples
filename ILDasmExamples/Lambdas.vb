Public Module Lambdas
    Public Sub Main()
        ' Using lambda functions results in some compilation magic to make them act like delegates
        ' In most cases, the body of the lambda will get defined statically inside a separate class generated by the compiler
